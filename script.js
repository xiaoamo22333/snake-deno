...
function initializeGame() {
    ...
    snake = [{ x: Math.floor(CANVAS_WIDTH / GRID_SIZE / 2), y: Math.floor(CANVAS_HEIGHT / GRID_SIZE / 2) }];
    dx = 0;
    dy = 0;
    score = 0;
...
function clearCanvas() {
    const canvasBgColor = getComputedStyle(document.documentElement).getPropertyValue('--canvas-bg-color');
